...
from src.data_access.thyroid_data import ThyroidData
    ...
    def export_data_into_raw_data_dir(self) -> pd.DataFrame:
        ...
        try:
            ...
            for collection_name, dataset in income_data.export_collections_as_dataframe():
                ...
                logging.info(f'data uploaded in the corresponding file location{feature_store_file_path}')

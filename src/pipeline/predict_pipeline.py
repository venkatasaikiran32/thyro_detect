...
class PredictionFileDetail:
    ...
    downloaded_model=os.path.join(artifact_folder,"downloaded_model")
...
class PredictionPipeline:
    ...
    def predict(self, features):
            try:
                os.makedirs(self.prediction_file_detail.downloaded_model,exist_ok=True)
                dest_file_path=os.path.join(self.prediction_file_detail.downloaded_model,'model.pkl')
    ...
    def save_input_files(self) -> str:
        ...
        try:
            ...
            logging.info(f"Directory created or exists: {pred_file_input_dir}")
    ...
    def get_predicted_dataframe(self, input_dataframe_path:pd.DataFrame):
        ...
        try:
            ...
            target_column_mapping = {0:'not hypothyroid', 1:'hyperfunction',2:'subnormal functioning'}
